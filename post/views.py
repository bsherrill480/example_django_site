...
class PostViewSet(ModelViewSet):
    ...
    # To share post with a group, create feeditems with the
    # given post instance for every group member
    @staticmethod
    def perform_create_group_post(post_instance, to_group_id):
    ...
    # To pst news to the feed, create a post by taking
    # a user_id parameter and make a feeditem for this user
    @staticmethod
    def perform_create_user_post(post_instance, to_user_id):
